...
Not really a message type, but a different method of saving a message in the SSB ecosystem.
...
Once decrypted by one of the intentend recipients, the message will be just like the other messages on SSB.