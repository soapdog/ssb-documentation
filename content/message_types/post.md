...
* `recps`: which holds the recipients for the messages and is used by private messages
* `mentions`: which is used to help link mentioned users, blobs, and other messages.
